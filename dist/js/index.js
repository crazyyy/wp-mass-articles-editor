...
/* WEBPACK VAR INJECTION */(function($, jQuery) {function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
...
$('.start-button').on('click', function (e) {
  ...
  jQuery.post(ajax_object.ajax_url, data, function (response) {
    ...
    var obj = JSON.parse(response); //      console.log(obj.count);
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 13:
            ...
            _context.next = 16;
            return someAjaxPromiseAuthors(chunks[n]);

          case 16:
            reslt = _context.sent;
            console.log("Finished ".concat(n, " of ").concat(chunks.length));
            console.log(reslt);
...
function split_for_chunk_and_foreach(ids) {
  ...
  _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
    var data, _i2, _data2, e, i, n, reslt;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 13:
            ...
            _context2.next = 16;
            return someAjaxPromise(chunks[n]);
    ...
    setTimeout(function () {
      $.ajax({
        ...
        error: function error(XMLHttpRequest, textStatus, errorThrown) {
          ...
          console.log(XMLHttpRequest);
          console.log("Status: ".concat(textStatus));
...
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! jquery */ "./node_modules/jquery/dist/jquery.js?fe57"), __webpack_require__(/*! jquery */ "./node_modules/jquery/dist/jquery.js?fe57")))
