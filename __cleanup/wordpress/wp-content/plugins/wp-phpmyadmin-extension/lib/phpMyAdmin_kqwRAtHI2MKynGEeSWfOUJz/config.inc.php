...
$cfg['blowfish_secret']					= ':!f*4GSnQo{Isoy\"+RWeoY730:K(pA|W' ;  // i.e. '$b~`lnkwm>^^jNUEE;(4xB$L\'b?."\'o9' 
...
$cfg['PmaAbsoluteUri'] 					= '/wp-content/plugins/wp-phpmyadmin-extension/lib/phpMyAdmin_kqwRAtHI2MKynGEeSWfOUJz/';			//used, if different directory by htaccess ; or parse_url($GLOBALS['PMA_PHP_SELF']);
